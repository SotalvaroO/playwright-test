...
(async () => {
    ...
    await page.goto('https://opencart.abstracta.us:443/index.php?route=account/logout')

    await page.click('text=My Account')
    await page.click('text=Login')

    await expect(page.click('text=Login')).toHaveURL('https://opencart.abstracta.us/index.php?route=account/login')
